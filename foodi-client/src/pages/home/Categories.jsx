...
const CategoryItems = [
    ...
    {id:2, title:"Break Fast", des:"(12 break fasts)", image:"categories/img2.png"},
    {id:3, title:"Dessert", des:"(30 desserts)", image:"categories/img3.png"},
    {id:4, title:"Browse All", des:"(225 items)", image:"categories/img4.png"},
]
const Categories = () => {
  return (
